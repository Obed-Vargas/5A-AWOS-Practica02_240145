...
function validacionUsuarioLogeado() {
  ...
  if (hayUsuarioLogeado === true) {
    console.log(
      "Dado que se ha logeado un usuario la app mostrara el menu del usuario"
    );
  } else if (hayUsuarioLogeado) {
    console.log(
      "Dado que no hay usuario logeado la app no mostrara el menu del usuario"
    );
  } else {
    console.log(
      "no puedo procesar este tipo de dato, requiero un dato booleano"
    );
  }
}
...
let descriptionProperty =
  "Casa de 2 pisos, 4 habitaciones, 2 baños completos y estacionamiento para 2 automóviles a orilla del mar.";
...
console.log(
  `Descripcion de la propiedad ${descriptionProperty.toLocaleLowerCase()}`
);
//Numero de caracteres
console.log(`Tipo de propiedad ${typeProperty.length}`);
//subcadena
console.log(
  `Nombre del propietario ${fullnameOwner.slice(5, fullnameOwner.length)}`
);
//Eliminar espacios en blanco
console.log(`Nombre de la propiedad ${nameProperty.trim()}`);
//Remplazar caracteres
console.log(
  `Descripcion modificada ${descriptionProperty.replace("Mar", "Rio")}`
);
//Remplazar todos los caracteres
console.log(
  `Descripcion modificada ${descriptionProperty
    .toLocaleUpperCase()
    .replaceAll("A", "4")}`
);
...
console.log(
  `El valor del numeroGrande es: ${numeroGrande} y es soportado por : ${typeof numeroGrande}`
);
...
console.log(
  `El valor del numeroGrande4 es: ${numeroGrande4} y es soportado por : ${typeof numeroGrande4}`
);

numeroGrande2 = BigInt("12345678901234567890");
console.log(
  `si declaramos la variable con el valor de numeroGrande2 es: ${numeroGrande2} un tipo de dato: ${typeof numeroGrande2}`
);

numeroGrande3 = BigInt("123456789012345678901234567890");
console.log(
  `si declaramos la variable con el valor de numeroGrande3 es: ${numeroGrande3} un tipo de dato: ${typeof numeroGrande3}`
);

numeroGrande4 = BigInt("1234567890123456789012345678901234567890");
console.log(
  `si declaramos la variable con el valor de numeroGrande4 es: ${numeroGrande4} un tipo de dato: ${typeof numeroGrande4}`
);
...
else console.log("Las variables numero1 y numero2 no son iguales en valor.");
if (numero1 == numero3)
  console.log("Las variables numero1 y numero3 son igulaes en valor.");
else console.log("Las variables numero1 y numero3 no son iguales en valor.");
if (numero1 === numero4)
  console.log("Las variables numero1 y numero4 son igulaes en valor.");
else console.log("Las variables numero1 y numero4 no son iguales en valor.");
if (numero1 == numero5)
  console.log("Las variables numero1 y numero5 son igulaes en valor.");
else console.log("Las variables numero1 y numero5 no son iguales en valor.");
if (numero5 == numero6)
  console.log("Las variables numero5 y numero6 son igulaes en valor.");
else console.log("Las variables numero5 y numero6 no son iguales en valor.");
...
if (todayDate == lastLogin) isNewUser = true;
